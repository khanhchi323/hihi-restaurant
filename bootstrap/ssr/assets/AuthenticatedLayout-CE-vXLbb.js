  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Menu for Staff `);
          } else {
            return [
              createTextVNode(" Menu for Staff ")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("category.list")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Category `);
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("menu.list")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Menu `);
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("area.list")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Area `);
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        active: _ctx.route().current("table.list")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Table `);
