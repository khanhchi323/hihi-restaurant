        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(props.tables, (table) => {
              _push2(`<tr class="text-center"${_scopeId}><td class="border px-4 py-2"${_scopeId}>${ssrInterpolate(table.id)}</td><td class="border px-4 py-2"${_scopeId}>${ssrInterpolate(table.table_name)}</td><td class="border px-4 py-2"${_scopeId}>`);
              if (__props.areas && __props.areas[table.area_id]) {
                _push2(`<span${_scopeId}>${ssrInterpolate(__props.areas[table.area_id].area_name)}</span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</td><td class="border px-4 py-2"${_scopeId}><div class="flex flex-col space-y-2"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(Link), {
                tabIndex: "1",
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList(props.tables, (table) => {
                            return openBlock(), createBlock("tr", {
                              ...
                              createVNode("td", { class: "border px-4 py-2" }, [
                                __props.areas && __props.areas[table.area_id] ? (openBlock(), createBlock("span", { key: 0 }, toDisplayString(__props.areas[table.area_id].area_name), 1)) : createCommentVNode("", true)
                              ]),
                              createVNode("td", { class: "border px-4 py-2" }, [
