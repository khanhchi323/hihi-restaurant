  ...
  <div class="py-12">
      ...
      <div class="p-6 bg-white border-b border-gray-200">
          ...
          <Link className="px-6 py-2 text-white bg-green-500 rounded-md focus:outline-none"
              :href="route('category.create')"> Create Post</Link>                 
        </div>
        ...
        <tr v-for="menu in filteredMenus" :key="menu.id" class="text-center">
          ...
          <td class="border px-2 w-16">
            <div class="flex flex-col text-white ">
              ...
              <Link className="px-6 py-2 text-white bg-sky-500 rounded-md focus:outline-none"
              :href="route('category.create')">Edit</Link>
