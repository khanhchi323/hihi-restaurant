<template>
  <div class="mx-16 mb-10 ">
    <h1 class=" flex justify-center text-2xl font-bold mb-4">Category List</h1>
    ...
    <div class="flex space-x-4 mb-4">
      ...
      <div class="w-1/3 text-right  ">
          <a href="{{ route('category.create') }}" class="btn btn-primary bg-green-400 p-3 rounded rounded-lg px-5 ">Add</a>  
      </div>
    </div>
...
export default {
  ...
  mounted() {
    ...
    this.menus = [
      { id: 1, category: 'Thịt', img: '' },
      { id: 2, category: 'Thịt',  img: '' },
      { id: 3, category: 'Hải sản', img: '' },
      { id: 4, category: 'Nước uống', img: '' }
    ];
  }
};
</script>